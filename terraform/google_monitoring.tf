...
resource "google_monitoring_alert_policy" "cis2_4_project_owner_change"{
  ...
  conditions {
      ...
      condition_threshold {
        ...
        duration = "60s"
        filter = "metric.type=\"logging.googleapis.com/user/${google_logging_metric.cis2_4_project_owner_change.name}\" AND resource.type=\"any\""
        threshold_value = 0
        trigger {
          count = 1
        }
...
resource "google_monitoring_alert_policy" "cis2_5_audit_config_change"{
  ...
  conditions {
      ...
      condition_threshold {
        ...
        comparison = "COMPARISON_GT"
        duration = "60s"
        filter = "metric.type=\"logging.googleapis.com/user/${google_logging_metric.cis2_5_audit_config_change.name}\" AND resource.type=\"any\""
        threshold_value = 0
        trigger {
          count = 1
        }
...
resource "google_monitoring_alert_policy" "cis2_6_custom_role_change"{
  ...
  conditions {
      ...
      condition_threshold {
        ...
        comparison = "COMPARISON_GT"
        duration = "60s"
        filter = "metric.type=\"logging.googleapis.com/user/${google_logging_metric.cis2_6_custom_role_change.name}\" AND resource.type=\"any\""
        threshold_value = 0
        trigger {
          count = 1
        }
...
resource "google_monitoring_alert_policy" "cis2_10_storage_iam_change"{
  ...
  conditions {
      ...
      condition_threshold {
        ...
        comparison = "COMPARISON_GT"
        duration = "60s"
        filter = "metric.type=\"logging.googleapis.com/user/${google_logging_metric.cis2_10_storage_iam_change.name}\" AND resource.type=\"any\""
        threshold_value = 0
        trigger {
          count = 1
        }
...
resource "google_monitoring_alert_policy" "cis2_11_sql_instance_change"{
  ...
  conditions {
      ...
      condition_threshold {
        ...
        comparison = "COMPARISON_GT"
        duration = "60s"
        filter = "metric.type=\"logging.googleapis.com/user/${google_logging_metric.cis2_11_sql_instance_change.name}\" AND resource.type=\"any\""
        threshold_value = 0
        trigger {
          count = 1
        }
